...
dataset_config = BaseDatasetConfig(
    formatter="ntq_khmer",
    meta_file_train="/home/coder/datasets/crawl_datasets/final_dataset/single_speaker/train_single_speaker_phonem.csv",
    meta_file_val="/home/coder/datasets/crawl_datasets/final_dataset/single_speaker/val_single_speaker_phonem.csv",
    path='/home/coder/datasets/crawl_datasets/final_dataset/'
)
...
_numbers     = '0123456789'
_khmer_phonetic_chars = 'abcdefhijklmnoprstuwzðĕŋŏŭɑɓɔɗəɛɡɨɪɲɹʃʊʋʌʔʰː ' 
...
config = VitsConfig(
    model_args=vitsArgs,
    audio=audio_config,
    run_name="vits_khmer_single_speaker_phonem",
    ...
    test_sentences=[
        ["keː cɑmʔɑːʔ kɲom haəj nɨwtae tɨɲ muːlənitʰiʔ pʰiəʔhun pacceikaʔʋitʰjiə ɗael miən tɑmlaj kpŭəh ɓɑnt tɨw rɔhout coul ɗɑl cʰnam piː pŏən piː"],
        ["maːtin luːtʰɨəkhiŋ ban niəjaj tʰaː pʰiəp saʔup tʰwɨəʔ ʔaɨ cʰiəvit cʰuəp kʰaŋ"],
        ["sʰtʰaːn pʰiəp tʰaːj kɑmpuːcɨa cɑp pʰɗɨəm ŋaːk pʰɗoːl pʰal prɑjoːc ʔaɨ tʰaːj cʰraən"],
    ],
)
