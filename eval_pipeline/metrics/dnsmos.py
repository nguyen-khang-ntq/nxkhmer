...
class DNSMOSCalculator:
    """Wrapper class for DNSMOS calculation"""
    
    def __init__(self, model_path, device="cpu", is_personalized_MOS=False):
        """
        Initialize DNSMOS calculator
        ...
        """
        self.compute_score = ComputeScore(model_path, device)
    ...
    def calculate(self, audio_path):
        ...
        Returns:
            dict: Dictionary containing MOS scores (OVRL, SIG, BAK)
        """
        return self.compute_score(audio_path, None, self.is_personalized_MOS)
